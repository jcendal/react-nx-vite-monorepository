...
[Learn more about this workspace setup and its capabilities](https://nx.dev/getting-started/tutorials/react-monorepo-tutorial?utm_source=nx_project&utm_medium=readme&utm_campaign=nx_projects)
or run `npx nx graph` to visually explore what was created. Now, let's get you
up to speed!

## Finish your CI setup

[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/2Bc6Vljpoa)
...
```sh
npx nx serve memegle-pwa
```

To create a production bundle:

```sh
npx nx build memegle-pwa
```

To see all available targets to run for a project, run:

```sh
npx nx show project memegle-pwa
```
